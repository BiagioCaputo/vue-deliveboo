...
<template>
    <!-- <div class="modal" :class="{ 'is-active': isActive }" id="exampleModal" tabindex="-1"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog my-modal-bg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="customer-fullname" class="col-form-label">Nome e Cognome</label>
                            <input type="text" class="form-control" id="customer-fullname">
                        </div>
                        <div class="mb-3">
                            <label for="customer-address" class="col-form-label">Indirizzo spedizione</label>
                            <input type="text" class="form-control" id="customer-address">
                        </div>
                        <div class="mb-3">
                            <label for="payment-method" class="col-form-label">Indirizzo spedizione</label>
                            <select class="form-control" id="payment-method">
                                <option value="">--Seleziona un metodo di pagamento</option>
                                <option value="">Carta di credito</option>
                                <option value="">--Seleziona un metodo di pagamento</option>
                            </select>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    <button type="button" class="custom-btn btn btn-danger" @click="$emit('close-modal')">Close</button>
                    <button type="button" class="custom-secondary-btn btn me-3">Send message</button>
                </div>
            </div>
        </div>
    </div> -->
